...
// This is an airdrop contract for the Pamp Network (PAMP): https://pamp.network
contract Airdrop is Ownable {
    ...
    function claimAirdrop(uint256 amount, bytes memory signature) public {
        require(!claimedAddrs[msg.sender], "Address already claimed airdrop");
